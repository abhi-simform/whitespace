...
export default function WorkTogether() {
  return (
    <section className="py-20 lg:py-32 px-6 lg:px-8 bg-whitepace-light-gray">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start gap-16 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <h2 className="text-whitepace-text-dark font-inter text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-6">
              Work
              <br />
              <span className="text-whitepace-text-dark">together</span>
            </h2>
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-start">
            <div className="relative">
              ...
              <div className="bg-whitepace-bg-blue w-80 h-80 lg:w-96 lg:h-96 xl:w-[500px] xl:h-[350px] rounded-lg flex items-center justify-center">
                {/* Placeholder for collaboration illustration */}
              ...
              <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-whitepace-light-blue rounded-full opacity-60"></div>
            </div>
          </div>
        </div>
      </div>
